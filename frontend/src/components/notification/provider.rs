...
use super::{
    ...
    manager::{Action, NotificationsList},
    use_effect_with_deps, use_reducer_eq, Callback, Children, Classes, ContextProvider, Html,
    Notifiable, NotifiableComponentFactory, NotificationsManager, Properties,
};
...
>(
    ...
    use_effect_with_deps(
        |(is_active, sender)| {
            ...
            let interval =
                Interval::new(NotificationsList::<N>::TIME_TICK_MILLIS as u32, move || {
                    if is_active {
